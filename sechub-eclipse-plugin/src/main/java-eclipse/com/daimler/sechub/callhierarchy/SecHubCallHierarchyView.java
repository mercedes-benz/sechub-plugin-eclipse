...
package com.daimler.sechub.callhierarchy;
...
import com.daimler.sechub.provider.CallHierarchyLabelProvider;
import com.daimler.sechub.provider.FindingModelTreeContentProvider;
import com.daimler.sechub.provider.FindingNodeColumLabelProviderBundle;
import com.daimler.sechub.provider.OnlyInputElementItselfTreeContentProvider;
...
public class SecHubCallHierarchyView extends ViewPart {
	...
	public static final String ID = "com.daimler.sechub.views.SecHubCallHierarchyView";
